...
import { startOfDay, isSameDay, addDays } from '../family-board.util.js';
        ...
        const dayStats = cells.map((d) => {
            if (!d) return { d: null, isToday: false, pips: [], remaining: 0, dayTotal: 0 };
                ...
                for (const e of mergedEvents) {
                    ...
                    const current = perPerson.get(id) || { color, textColor, count: 0 };
                    current.count += 1;
                    ...
                    <div class="cal">
                        <div class="head">
                            ...
                            <div style="display:flex;gap:8px">
                                <button class="btn" @click=${() => card._setMonthOffset(-1)}
                                    ><</button
                                >
                                <button class="btn" @click=${() => card._setMonthOffset(1)}>
                                    >
